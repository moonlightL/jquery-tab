;(function($){
    ...
    function initTabContainer(obj) {
        ...
        arr.push("<a href='javascript:;'><i class='zmdi zmdi-arrow-left'></i></a>");
        arr.push("</div>");
        arr.push("<div class='tab-right'>");
        arr.push("<a href='javascript:;'><i class='zmdi zmdi-arrow-right'></i></a>");
        arr.push("</div>");
    ...
    function initScrollShow() {
        if (document.getElementById('jquery-tabs').scrollWidth > document.getElementById('jquery-tabs').clientWidth) {
            $('.tab-container-menu').addClass('scroll');
        } else {
            $('.tab-container-menu').removeClass('scroll');
        }
    }
    ...
    function initScrollState($tabContainer) {
        ...
        if (($tabContainer.scrollLeft() + document.getElementById('jquery-tabs').clientWidth) >= document.getElementById('jquery-tabs').scrollWidth) {
    ...
    let TabManager = {
        openTab: function(obj) {
            ...
            if ($("#tab_" + index).length > 0) {
                ...
                // 创建 tab
                let tab = "<li class='tabs-item active' id='tab_"+index+"' data-close='true' data-index='"+ index +"' data-url='"+ url +"'><a href='javascript:;' class='waves-effect waves-light'>"+tabName+"</a></li>";
