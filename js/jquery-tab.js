;(function($){
  ...
  window.changeFrameHeight = function(iframe) {
    iframe.height =  document.documentElement.clientHeight - defaultSetting.bottomHeight;
  }

  window.onresize = function() {
      $(".tab-iframe").height(document.documentElement.clientHeight - defaultSetting.bottomHeight);
  }
